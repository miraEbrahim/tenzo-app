...
//create date format for shift start and end
let startShiftTimeThree = new Date(
  "01/01/2007 " + startTimeValuesThree
).getHours();
...
//break end time
let breakTimeEndThree = breakNotesValuesThree
  .replace("4PM-", "")
  .replace("PM", "");
...
//create date format for shift start and end
let startShiftTimeFour = new Date(
  "01/01/2007 " + startTimeValuesFour
).getHours();
...
//create date format for shift start and end
let startShiftTimeFive = new Date(
  "01/01/2007 " + startTimeValuesFive
).getHours();
...
//create date format for shift start and end
let startShiftTimeSeven = new Date(
  "01/01/2007 " + startTimeValuesSeven
).getHours();
...
export let restaurantLabourCost =
  labourCostShiftOne +
  labourCostShiftTwo +
  labourCostShiftThree +
  labourCostShiftFour +
  labourCostShiftFive +
  labourCostShiftSix +
  labourCostShiftSeven;
